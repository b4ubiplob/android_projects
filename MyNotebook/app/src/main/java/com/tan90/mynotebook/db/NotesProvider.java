...
public class NotesProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.tan90.mynotebook.notesprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return database.query(DBOpenHelper.TABLE_NOTES, DBOpenHelper.NOTES_TABLE_COLUMNS, selection, null,
